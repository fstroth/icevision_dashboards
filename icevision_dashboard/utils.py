...
__all__ = ['ObservableList', 'RecordDataframeParser', 'RecordDataset', 'calculate_mixing_matrix',
           'convert_rgb_image_to_bokeh_rgb_image', 'draw_record_with_bokeh', 'barplot', 'histogram', 'histogram_2d',
           'time_arc_plot', 'table_from_dataframe', 'create_datasets_overview', 'generate_range_filter',
...
# Cell
class RecordDataset:
    def __init__(self, records: Union[list, ObservableList], class_map=None):
    ...
    @classmethod
    def load_from_record_data(cls, record_data_df: pd.DataFrame, class_map=None):
