...
__all__ = ['DatasetFilter', 'TrainValRecordsComparison']
...
class DatasetFilter:
    ...
    def __init__(self, records, class_map=None, export_variable: Union[list, None] = None, height=500, width=500):
        ...
        self.data = pd.DataFrame(aggregate_record_data(records))
        if class_map is not None:
            self.data["label_num"] = self.data["label"]
            self.data["label"] = self.data["label"].apply(class_map.get_id)
